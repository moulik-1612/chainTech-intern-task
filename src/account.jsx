...
<div className="container mt-5" style={{ maxWidth: "500px" }}>
    ...
    <div className="form-group mb-3">
        <input type="text" placeholder="Name" value={userData.name} onChange={handleForm} name="name" className="form-control" autoComplete="off"/>
    </div>

    <div className="form-group mb-3">
        <input type="email" placeholder="Email" value={userData.email} onChange={handleForm} name="email" className="form-control" autoComplete="off"/>
    </div>
                
    <div className="form-group mb-3">
        <input type="password" placeholder="Password" value={userData.password} onChange={handleForm} name="password" className="form-control"autoComplete="off"/>
    </div>
